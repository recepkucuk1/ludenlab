...
import { matematikInputSchema } from "@/lib/matematik";
import { generateMatematik } from "@/lib/matematik-prompts";
...
export async function POST(req: Request) {
  ...
  try {
    const charged = await withCredits(session.user.id, () => generateMatematik(parsed.data));
