...
// (atolye/hub'ın kanıtlanmış reçetesi — app adı `studio`.)
import { cpSync, existsSync, mkdirSync, readdirSync, lstatSync, readlinkSync } from "node:fs";
import path from "node:path";

const appDir = path.resolve(import.meta.dirname, "..");
const standaloneApp = path.join(appDir, ".next", "standalone", "apps", "studio");
...
// Çözüm: iyzipay'i (resources dahil) + tüm bağımlılık KAPANIŞINI standalone'un
