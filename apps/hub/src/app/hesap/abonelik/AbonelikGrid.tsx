...
const STUDIO_PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    period: "ay",
    yearlyPeriod: "yıl",
    features: ["200 öğrenciye kadar kayıt", "Aylık 100 üretim hakkı", "Tüm araçlar, görselli PDF çıktı"],
  ...
  },
  {
    ...
    period: "ay",
    yearlyPeriod: "yıl",
    features: ["Sınırsız öğrenci kaydı", "Aylık 500 üretim hakkı", "Tüm araçlar, görselli PDF çıktı"],
  ...
  },
  {
    ...
    yearlyPrice: null,
    period: "ay",
    features: ["Sınırsız öğrenci", "Sınırsız üretim", "Kuruma özel fiyat ve sözleşme"],
