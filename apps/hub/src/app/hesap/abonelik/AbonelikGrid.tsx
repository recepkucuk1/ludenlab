...
const STUDIO_PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    period: "ay",
    yearlyPeriod: "yıl",
    features: ["Sınırsız öğrenci kaydı", "Aylık 500 üretim hakkı", "Tüm premium özellikler", "Öncelikli destek"],
  ...
  },
  {
    ...
    yearlyPrice: null,
    period: "ay",
    features: ["Sınırsız öğrenci", "Sınırsız üretim", "Kuruma özel entegrasyon", "7/24 Özel Destek Uzmanı"],
