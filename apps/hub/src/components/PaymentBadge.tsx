...
/**
 * Güvenli ödeme rozeti — iyzico resmi logoları. Asset: public/iyzico/*.svg (resmi marka paketi).
 * (Ad `PaymentBadge` kaldı — sağlayıcı değişimlerinde 8 kullanım yeri değişmesin.)
 *
 ...
 * `.dark`). `onDark=true` → her zaman beyaz varyant (sabit-koyu yüzeyler).
 */
