...
import { PDF_FONT_STACK } from "@/lib/pdfFonts";
...
// Yalnız kontrol karakterlerini temizle. Emoji ve simgeler (→ ✓ + = ×) artık
// PDF_FONT_STACK ve emoji kaynağıyla çizilebildiği için silinmez.
