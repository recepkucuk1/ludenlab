...
import { PButton, PModal } from "@ludenlab/ui";
 ...
 *
 * On open we POST to /atolye/api/subscription/checkout, get back the iyzico
 ...
 *
 * After successful payment iyzico POSTs to /atolye/api/subscription/callback,
    ...
    >
      {error ? (
        <div style={{ textAlign: "center", padding: "32px 8px" }}>
          ...
          <PButton onClick={onClose} variant="ghost" size="md">
            Kapat
          </PButton>
        </div>
      ) : (
