...
export const words: Record<Position, BankWord[]> = {
  initial: [
    ...
    { word: "gerdanlık", syllableBreak: "ger-dan-lık", visualPrompt: "a necklace of colorful round beads" },
    { word: "gaga", syllableBreak: "ga-ga", visualPrompt: "a colorful bird head in profile showing a big yellow beak" },
    ...
    { word: "gevrek", syllableBreak: "gev-rek", visualPrompt: "a round sesame-covered bread ring (Turkish simit)" },
  ...
  medial: [
    ...
    { word: "magazin", syllableBreak: "ma-ga-zin", visualPrompt: "a glossy magazine lying open with colorful photos of people" },
    { word: "program", syllableBreak: "prog-ram", visualPrompt: "a television set showing a colorful cartoon show on its screen" },
